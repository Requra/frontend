...
export const LandingPage = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="relative pt-24 pb-40 overflow-hidden flex flex-col items-center justify-center min-h-[80vh] w-full">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl tracking-tight">
          <h1 className="text-5xl md:text-7xl font-extrabold mb-8 leading-tight">
            ...
            <span className="text-gradient-primary">Requra.AI</span>
          </h1>
          <p className="text-xl md:text-2xl text-neutral-600 mb-12 max-w-3xl mx-auto leading-relaxed">
            The smartest way to automate your workflows and scale your business
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Button
              variant="outline"
              size="lg"
              className="rounded-full px-10 h-14 text-lg border-2 border-neutral-200 text-neutral-900 hover:bg-neutral-100"
            >
              View Demo
            </Button>
          </div>
